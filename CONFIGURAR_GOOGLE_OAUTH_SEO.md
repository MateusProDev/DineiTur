...
2. Selecione seu projeto (provavelmente "crested-return-478220-d6" ou "dineitur")
...
4. Configure:
   - **Nome**: "DineiTur Dashboard SEO"
   - **URIs de redirecionamento autorizadas**:
     - Para desenvolvimento: `http://localhost:3000`
     - Para produção: `https://DineiTur.com.br`
     - Para Vercel preview: `https://dineitur-[seu-nome].vercel.app`
...
2. Adicione a propriedade: `https://DineiTur.com.br`
...
Se aparecer erro, é porque falta o Client ID válido.