...
AGENCY_FROM = reservas@DineiTur.com.br
AGENCY_REPLY_TO = atendimento@DineiTur.com.br
AGENCY_EMAIL = contato@DineiTur.com.br
...
O domínio `DineiTur.com.br` é só a **URL do site**. Para enviar e-mails, você precisa de um **servidor SMTP** (que é separado).
...
2. Selecione o projeto **DineiTur**
...
```
Nome: AGENCY_FROM
Valor: reservas@DineiTur.com.br
Ambientes: Production, Preview, Development
```

```
Nome: AGENCY_REPLY_TO
Valor: atendimento@DineiTur.com.br
Ambientes: Production, Preview, Development
```

```
Nome: AGENCY_EMAIL
Valor: contato@DineiTur.com.br
Ambientes: Production, Preview, Development
```
...
1. Acesse seu site: https://DineiTur.com.br/reservas
...
2. Acesse no navegador:
   ```
   https://DineiTur.com.br/api/test-email?to=SEU_EMAIL@GMAIL.COM&key=teste123
   ```

3. Verifique se chegou e-mail com assunto "Teste SMTP DineiTur"
...
- ✅ Verifique o e-mail `reservas@DineiTur.com.br`
...
1. ✅ Criar conta Brevo
2. ✅ Gerar chave SMTP
3. ✅ Verificar remetente (reservas@DineiTur.com.br)
...
- [ ] Remetente `reservas@DineiTur.com.br` verificado
