...
async function enviarEmail(reserva, reservaId, pdfBytes) {
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <p>Obrigado por escolher a DineiTur</p>
          </div>
          ...
          <div class="content">
            ...
            <div class="info-box contact-info">
              ...
              <p><strong>📧 Email:</strong> contato@DineiTur.com.br</p>
            </div>
          ...
          <div class="footer">
            <p class="footer-brand">DineiTur</p>
  ...
  console.log('✅ Notificação enviada para dineitur000@gmail.com');
}
