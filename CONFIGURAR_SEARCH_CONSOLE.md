...
O erro 403 significa que você não tem acesso ao **Google Search Console** do domínio `DineiTur.com.br`.
...
2. **Importante:** Use a conta `dineitur000@gmail.com`

### **Passo 2: Verificar se o Domínio Está Adicionado**
1. Na página inicial, procure por: `DineiTur.com.br`
...
3. Digite: `https://DineiTur.com.br`
...
1. Volte para: https://DineiTur.com.br/admin
...
- Você (`dineitur000@gmail.com`) deve estar como **Proprietário**

## 🚨 Possíveis Problemas

### **Erro: "Você não tem permissão"**
- ❌ Conta errada: Use `dineitur000@gmail.com`
- ❌ Domínio errado: Deve ser exatamente `DineiTur.com.br`
...
**Configure o Search Console primeiro, depois teste novamente!** 🚀