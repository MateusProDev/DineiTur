...
- [ ] `REACT_APP_FIREBASE_AUTH_DOMAIN` = `dineitur.firebaseapp.com`
- [ ] `REACT_APP_FIREBASE_PROJECT_ID` = `dineitur`
- [ ] `REACT_APP_FIREBASE_STORAGE_BUCKET` = `dineitur.firebasestorage.app`
