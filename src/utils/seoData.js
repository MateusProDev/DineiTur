...
export const seoData = {
  ...
  sobre: {
    title: 'Sobre a DineiTur - Nossa História e Missão',
    description: 'Conheça a DineiTur: missão, valores e nossa história levando clientes aos melhores destinos do Ceará com segurança e conforto.',
    canonical: '/sobre',
    noindex: true
  },
  
  pacotes: {
    title: 'Nossos Pacotes - DineiTur',
  ...
  destinos: {
    title: 'Nossos Destinos - DineiTur',
  ...
  blog: {
    title: 'Blog de Viagens - DineiTur',
  ...
  avaliacoes: {
    title: 'Depoimentos e Avaliações Reais dos Nossos Clientes - DineiTur',
  ...
  reservas: {
    title: 'Faça Sua Reserva de Transfer ou Passeio Online - DineiTur',
  ...
  politica: {
    title: 'Política de Reservas - DineiTur',
    description: 'Regras de reservas, cancelamento e pagamento da DineiTur. Transparência e informações claras para sua viagem.',
    canonical: '/politica',
    noindex: true
  },
  ...
  categorias: {
    passeio: {
      title: 'Passeios Turísticos Privativos em Fortaleza e Região - DineiTur',
    ...
    transfer: {
      title: 'Transfers e Traslados Privativos em Fortaleza - DineiTur',
    ...
    'beach-park': {
      title: 'Passeios Completos para Beach Park com Transfer Incluso - DineiTur',
